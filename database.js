...
const jobApplicationSchema = new mongoose.Schema({
  ...
  status: { type: String, default: 'Pending', enum: ['Waiting', 'Pending', 'Partially Done', 'Approved', 'Rejected'] },
...
const notificationSchema = new mongoose.Schema({
  ...
  type: {
      type: String,
  enum: ['task', 'project_creation', 'project_completion', 'join_request', 'join_request_approved', 'other', 'task_assignment', 'task_accepted', 'task_rejected', 'job_application', 'job_created', 'job_deleted', 'job_hired', 'job_rejected', 'job_on_hold'],
      default: 'task'
  },
